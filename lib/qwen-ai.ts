...
const FALLBACK_DASHSCOPE_KEY = "sk-13b496ecd89b490585f906b4e8b6fd98";
const FALLBACK_OPENROUTER_KEY =
  "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";
...
Suggest 2-4 Filipino recipes that can realistically be cooked with the identified ingredients.`;
  ...
  if (!content) {
    ...
    // Vision models to try — dedicated VL models first, general LLMs last
    const visionModels = [
      ...
      "qwen3.6-plus-free",           // OpenRouter free — general LLM (less accurate)
