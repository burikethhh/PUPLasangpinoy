...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyAZ36rq3scKZDT5SsETJ_SYIOEB9Gcbkyk",
  authDomain:
    process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN ||
    "lasangpinoy-mobile.firebaseapp.com",
  projectId:
    process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || "lasangpinoy-mobile",
  storageBucket:
    process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET ||
    "lasangpinoy-mobile.firebasestorage.app",
  messagingSenderId:
    process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "931661584129",
  appId:
    process.env.EXPO_PUBLIC_FIREBASE_APP_ID ||
    "1:931661584129:web:c9755a01f54a31cf29ed00",
};
