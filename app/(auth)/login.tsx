      ...
      >
        ...
        >
          <View style={styles.card}>
            ...
            <View
              style={[styles.inputBox, errors.password && styles.inputBoxError]}
            >
              <Ionicons
            ...
            {!resetSent ? (
              <>
                <View style={styles.modalIconBox}>
                  <Ionicons name="key-outline" size={32} color="#F25C05" />
                </View>
              ...
              <>
                ...
                <Text style={styles.modalSubtitle}>
                  ...
                  <Text style={{ fontWeight: "bold", color: "#2E1A06" }}>
                    {resetEmail}
                  </Text>
                </Text>
                ...
                <TouchableOpacity
                  style={[styles.signInBtn, { marginTop: 16 }]}
                  onPress={closeForgotModal}
                >
