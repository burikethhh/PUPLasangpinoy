...
EXPO_PUBLIC_QWEN_API_KEY=REDACTED_QWEN_API_KEY_OLD
```
...
|---------|----------|-------|---------|
| Firebase | API Key | `REDACTED_FIREBASE_API_KEY` | Web SDK authentication |
...
| Qwen AI | API Key | `REDACTED_QWEN_API_KEY_OLD` | AI Vision & Chat |
...
const firebaseConfig = {
  apiKey: process.env.EXPO_PUBLIC_FIREBASE_API_KEY || "REDACTED_FIREBASE_API_KEY",
...
```typescript
const QWEN_API_KEY = process.env.EXPO_PUBLIC_QWEN_API_KEY || 'REDACTED_QWEN_API_KEY_OLD';
